...
namespace Ogre {
    ...
    //---------------------------------------------------------------------
    bool LodStrategy::isSorted(const Mesh::LodValueList& values) const
    {
        // Determine if sorted ascending
        return isSortedAscending(values);
    }
        //---------------------------------------------------------------------
    void LodStrategy::sort(Mesh::MeshLodUsageList& meshLodUsageList) const
    {
        // Sort ascending
    ...
    //---------------------------------------------------------------------
    bool LodStrategy::isSortedDecending(const Mesh::LodValueList& values)
    {
        Mesh::LodValueList::const_iterator it = values.begin();
        Real prev = (*it);
        for (++it; it != values.end(); ++it)
    ...
    void LodStrategy::sortDecending(Mesh::MeshLodUsageList& meshLodUsageList)
    {
        // Perform standard sort
