...
-----------------------------------------------------------------------------
*/
#ifndef __GLRenderToVertexBufferObject_H__
...
namespace Ogre {
    ...
    @remarks
        ...
        shaders.
    */
	class _OgrePrivate GLRenderToVertexBufferObject : public RenderToVertexBufferObject
    {    
    public:
		/** C'tor */
		GLRenderToVertexBufferObject();
		/** D'tor */
        virtual ~GLRenderToVertexBufferObject();
